...
<div class="settings-panel wcpbc-zone-settings">
	...
	<?php endif; ?>
		...
		<tr valign="top">
			<th scope="row" class="titledesc">
				<label for="disable_tax_adjustment"><?php esc_html_e( 'Price entered with tax', 'woocommerce-product-price-based-on-countries' ); ?></label>
			</th>
